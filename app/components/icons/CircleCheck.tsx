...
const SvgComponent = (
  ...
  <svg
    ...
    ref={ref}
  >
    <g clipPath="url(#clip0_2932_6826)">
      <path
        ...
        fill="currentColor" // Changed from #1F8A70 to currentColor for better theme support
      />
    </g>
    <defs>
      <clipPath id="clip0_2932_6826">
...
const CircleCheck = memo(ForwardRef);
